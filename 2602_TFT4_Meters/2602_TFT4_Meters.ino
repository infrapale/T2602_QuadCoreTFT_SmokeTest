...
void setup(void) {
  ...
  Serial.printf("MISO %d MOSI %d SCLK %d CS %d DC %d RST %d BL %d T_CS %d\n",
      TFT_MISO, TFT_MOSI, TFT_SCLK, TFT_CS, TFT_DC, TFT_RST, TFT_BL, TOUCH_CS );
