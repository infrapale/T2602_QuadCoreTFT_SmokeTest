...
box_st box[BOX_NBR_OF] =
{
  ...
  {  0, 256, 480,  32, "Box 9", 4, 1, TFT_BLACK, TFT_GOLD, TFT_WHITE},
  {  0, 288, 480,  32, "Box 10",4, 1, TFT_BLACK, TFT_GOLD, TFT_WHITE},
...
void box_print(uint8_t rindx, char *txtp)
{
    strncpy(box[rindx+1].txt,txtp,BOX_TEXT_LEN);
    box_draw(rindx+1);
}
